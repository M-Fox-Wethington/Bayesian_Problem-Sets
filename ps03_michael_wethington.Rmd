...
$\lambda \backsim Gamma(\alpha, \beta)$

The likelihood:

$$ Gamma(\lambda| r, v) = \frac{v^{-r}\lambda^{r-1}e^{-v\lambda}}{\Gamma(r)}\propto\lambda^{r-1}e^{-v\lambda} $$

Prior Likelihood

$$\frac{v^r}{\Gamma(r)}\lambda^{r-1}e^{-v\lambda} \frac{1}{y!}\lambda^ye^{-\lambda}$$

$$\propto \lambda^{r-1}e^{-v\lambda}\lambda^ye^-\lambda$$
$$= \lambda^{r+y-1}e^{-(v+1)\lambda}$$
$$\lambda|r \backsim Gamma(r+y, v+1)$$
...
PoisUnif_Pst.plot <-  ggplot(Pois_Unif1.dat, aes(x=lambda, color="#9999")) +
  ...
  ggtitle("Poission-Uniform (Posteriors (0,10)")+
  theme_minimal()
...
PoisUnif_Pst.plot2 <-  ggplot(Pois_Unif2.dat, aes(x=lambda, color="#9999")) +
  ...
  ggtitle("Poission-Uniform (Posteriors (0,20)")+
  theme_minimal()
...
PoisUnif_Pst.plot3 <-  ggplot(Pois_Unif3.dat, aes(x=lambda, color="#9999")) +
  ...
  ggtitle("Poission-Uniform Posteriors (5,15)")+
  theme_minimal()
...
Pois_LgNorm.jags1.plot <-  ggplot(Pois_LgNorm.jags1.dat, aes(x=lambda, color="#9999")) +
  ...
  geom_histogram(fill="#d7191c", color="#e9ecef", alpha = 0.8, bins = 30)+
  ggtitle("Poission-Lognormal (Posteriors (0,10)")+
  theme_minimal()
...
Pois_LgNorm.jags2.plot2 <-  ggplot(Pois_LgNorm.jags2.dat, aes(x=lambda, color="#9999")) +
  ...
  geom_histogram(fill="#fdae61", color="#e9ecef", alpha = 0.8, bins = 30)+
  ggtitle("Poission-Lognormal(Posteriors (0,20)")+
  theme_minimal()
...
Pois_LgNorm.jags3.plot3 <-  ggplot(Pois_LgNorm.jags3.dat, aes(x=lambda, color="#9999")) +
  ...
  geom_histogram(fill="#91bfdb", color="#e9ecef", alpha = 0.8, bins = 30)+
  ggtitle("Poission-Lognormal Posteriors (5,15)")+
  theme_minimal()
...
#Calculate the MLE of the poisson data 
dax <- c(3,5,2,3,3,0,2,6,1,3)
fitdistr(dax, densfun = "Poisson")
