...
we have not found the inverse gamma distribution!
...
Our final posterior is $Invgamma(\alpha_0+\frac{n}{2},\beta_0+\frac{\sum(y_i-\mu)^2}{2} )$
...
n_list <- list(n.5, n.100, n.50, n.500, n.5000)
# 
# heights <- rnorm(n.100, mean = known.mean, sd=sqrt(unknown.sigma.sq))
# 
# #prior alphas
# alpha0 <- 5
# beta0 <- 20
...
for(i in n_list){
  heights <- rnorm(i, mean = known.mean, sd=sqrt(unknown.sigma.sq))
